        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item"  href="<?php echo site_url('student/export');?>">प्रवेशित CSV एक्स्पोर्ट </a>
                </div>
            </li>
               ...
               <form action="<?php echo site_url('login/verifylogin')?>" method="post">
                    <div class="input-group mb-3">
                        <div class="input-group-append">
                            <span class="input-group-text"><img src="<?php echo base_url('bootstrap/images/icons/man-user.png');?>"/></span>
                        </div>
                        <input type="text" name="username" class="form-control input_user" value="" placeholder="username" required>
                    </div>
                    <div class="input-group mb-2">
                        <div class="input-group-append">
                            <span class="input-group-text"><img src="<?php echo base_url('bootstrap/images/icons/key.png');?>"/></span>
                        </div>
