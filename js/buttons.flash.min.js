(function(g) {
    ...
    var y = function(a, b) {
        ...
        header: !0,
        footer: !1
    }, v = "", v = "undefined" === typeof k.XMLSerializer ? new function() {
    ...
    j.ext.buttons.excelFlash = g.extend({}, u, {
        ...
        action: function(a, b, d, c) {
            this.processing(!0);
            var a = c._flash, e = 0, f = g.parseXML(n["xl/worksheets/sheet1.xml"]), h = f.getElementsByTagName("sheetData")[0], d = {
                _rels: {
            ...
            p.title && (j([p.title], e),
                m(e, i.header.length - 1));
            p.messageTop && (j([p.messageTop], e),
                m(e, i.header.length - 1));
            c.header && (j(i.header, e),
                g("row:last c", f).attr("s", "2"));
            for (var s = 0, r = i.body.length; s < r; s++)
                j(i.body[s], e);
            c.footer && i.footer && (j(i.footer, e),
                g("row:last c", f).attr("s", "2"));
            p.messageBottom && (j([p.messageBottom], e),
                m(e, i.header.length - 1));
            j = o(f, "cols");
