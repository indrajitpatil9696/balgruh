...
(function(d) {
        ...
        collection: {
            ...
            action: function(a, b, c, e) {
                var g = d(c).parents("div.dt-button-collection")
                    ...
                    , f = !1
                    , i = c;
                g.length && (f = d(".dt-button-collection").position(),
                    i = g,
                ...
                c > d(n).width() && e._collection.css("left", a.left - (c - d(n).width()))) : (c = e._collection.height() / 2,
    ...
    i.Api.register("buttons.exportData()", function(a) {
        if (this.context.length) {
            var b = new i.Api(this.context[0])
                ...
                c.decodeEntities && (v.innerHTML = a,
                    a = v.value);
                return a
            }
    ...
    i.Api.register("buttons.exportInfo()", function(a) {
        ...
        b === m || null === b ? b = null : (-1 !== b.indexOf("*") && (b = d.trim(b.replace("*", d("head > title").text()))),
